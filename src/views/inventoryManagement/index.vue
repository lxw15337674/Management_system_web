    ...
    <div class="inventoryManagement">
        ...
        <div class="content" style="min-height: 60px; margin-bottom:30px">
            <el-row>
                ...
                <el-col :span="22">
                    <el-button type="text" style="padding: 10px 20px;font-size:18px; margin:0" @click="getCommodity()">
                        所有分类
                    </el-button>
        ...
        <div class="content" style="min-height: 700px;">
            <div style="margin-bottom:10px">
                ...
                <el-button style="float: right" size="small" type="success" @click="createCommodityDialog">新建商品
                </el-button>
            </div>
            <div>
                <el-row>
                                ...
                                <el-row>
                                    <el-col :span="9" style="padding:20px 5px">
                                        <div class="commodity-img">
                                            <img :src="item.pic_url" class="commodity-img" alt="">
                                        </div>
                                    </el-col>
